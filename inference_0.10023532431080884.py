...
if __name__ == "__main__":
    ...
    model_name = 'models/0.10023532431080884.h5'
    scaler_name = 'models/scaler_0.10023532431080884.pkl'
    label_encoder_name = 'models/label_encoder_0.10023532431080884.pkl'
