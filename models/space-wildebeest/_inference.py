...
if __name__ == "__main__":
    ...
    model_name = 'models/space-wildebeest/space-wildebeest.h5'
    scaler_name = 'models/space-wildebeest/scaler_space-wildebeest.pkl'
    label_encoder_name = 'models/space-wildebeest/label_encoder_space-wildebeest.pkl'
